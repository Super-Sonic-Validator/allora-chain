...
type StateTransitionCounts struct {
	...
	produceInferenceAndReputation int
}
...
func (s StateTransitionCounts) String() string {
	return "{\ncreateTopic: " + strconv.Itoa(s.createTopic) + ", " +
		...
		"\nproduceInferenceAndReputation: " + strconv.Itoa(s.produceInferenceAndReputation) +
		"\n}"
}
...
func (s *StateTransitionCounts) incrementProduceInferenceAndReputationCount() {
	s.produceInferenceAndReputation++
}
